...
const submit = evt => //Once submit button is clicked all this is preformed
{
    ...
    {
        evt.preventDefault();
        $("#totals").textContent = "Please fill in all required fields.";
    }
    ...
    var html = document.querySelector(`#totals`);

    var finalMessage = `<br> Gross Pay: $${gross.toFixed(2)} <br> Tax Amount: $${taxAmount.toFixed(2)} <br> Net Pay: $${net.toFixed(2)}`;
